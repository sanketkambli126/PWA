...
namespace PWAFeaturesRnd.Models.Report.InspectionManager
{
	...
	public class InspectionDetail
	{
		...
		/// </value>
		public bool? RefusalofAccessIssued { get; set; }
		...
		/// <summary>
		/// Gets or sets a value indicating whether [report required].
		/// </summary>
		/// <value>
		///   <c>true</c> if [report required]; otherwise, <c>false</c>.
		/// </value>
		...
		/// </value>
		/// Note : This will be used to update the Screening status based on Minimum OMV_Date and CompanyId
