...
namespace PWAFeaturesRnd.Models.Report.Shared
{
	...
	public class CompanySearchRequest
	{
		...
		/// <summary>
		/// Gets or sets a value indicating whether [fetch supplier assessment].
		/// </summary>
		/// <value>
		///   <c>true</c> if [fetch supplier assessment]; otherwise, <c>false</c>.
		/// </value>
		public bool FetchSupplierAssessment { get; set; }

		/// <summary>
		/// Gets or sets a value indicating whether [fetch default currency].
		/// </summary>
		/// <value>
		///   <c>true</c> if [fetch default currency]; otherwise, <c>false</c>.
		/// </value>
		...
		/// <summary>
		/// Gets or sets a value indicating whether [fetch ap valid].
		/// </summary>
		/// <value>
		///   <c>true</c> if [fetch ap valid]; otherwise, <c>false</c>.
		/// </value>
