...
{
	/// <summary>
	/// Inspection Fleet Summary Response VM
	/// </summary>
	public class InspectionFleetSummaryResponseViewModel
	{
		/// <summary>
		...
		/// </value>
		public string PscDeficiencyRate { get; set; }
		...
		/// </value>
		public string OMVFindingsRate { get; set; }
