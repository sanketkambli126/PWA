...
namespace PWAFeaturesRnd.ViewModels.HazardousOccurrences
{
    ...
    public class AccidentSummaryViewModel
    {
        ...
        /// </value>
        public string IsAccidentWorkRelated { get; set; }
        ...
        /// <summary>
        /// Gets or sets a value indicating whether this instance is passenger accident.
        /// </summary>
        /// <value>
        ///   <c>true</c> if this instance is passenger accident; otherwise, <c>false</c>.
        /// </value>
        public bool IsPassengerAccident { get; set; }
