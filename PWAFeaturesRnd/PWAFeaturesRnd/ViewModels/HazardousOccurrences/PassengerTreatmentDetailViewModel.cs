...
namespace PWAFeaturesRnd.ViewModels.HazardousOccurrences
{
    ...
    /// </summary>
    public class PassengerTreatmentDetailViewModel
    {
        /// <summary>
        ...
        /// </value>
        public string DisembarkedDate { get; set; }
        ...
        /// </value>
        public string SentToShoreDoctor { get; set; }
        ...
        /// </value>
        public string XRaysRecommended { get; set; }
        ...
        /// The visits.
        /// </value>
        public List<IncidentVisitViewModel> Visits { get; set; }
    }
}
