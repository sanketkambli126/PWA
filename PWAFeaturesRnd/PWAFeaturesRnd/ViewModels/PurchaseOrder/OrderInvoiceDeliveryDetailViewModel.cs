...
{
    /// <summary>
    /// order invoice delivery details view model
    /// </summary>
    public class OrderInvoiceDeliveryDetailViewModel
    {
        /// <summary>
        ...
        /// <summary>
        /// Gets or sets the remaining delivery days.
        /// </summary>
        /// <value>
        /// The remaining delivery days.
        /// </value>
        public int? RemainingDeliveryDays { get; set; }
    }
}
