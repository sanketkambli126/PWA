...
//						));
		...
		Tour.prototype._showPopover = function (step, i) {
			...
			if($(document).find(".tour-" + this._options.name + ".tour-" + this._options.name + "-" + this.getCurrentStepIndex()).length == 0)
			{
...
//		};
		...
		Tour.prototype._initMouseNavigation = function () {
			...
			return $(document).off("click.tour-" + this._options.name, ".tour-" + this._options.name + " *[data-role='prev']").off("click.tour-" + this._options.name, ".tour-" + this._options.name + " *[data-role='next']").off("click.tour-" + this._options.name, ".tour-" + this._options.name + " *[data-role='end']").off("click.tour-" + this._options.name, ".tour-" + this._options.name + " *[data-role='pause-resume']").on("click.tour-" + this._options.name, ".tour-" + this._options.name + " *[data-role='next']", (function (_this) {
				...
				})(this)).on("click.tour-" + this._options.name, ".tour-" + this._options.name + " *[data-role='prev']", (function (_this) {
					return function (e) {
						e.preventDefault();
						if (_this._current > 0) {
							return _this.prev();
				...
				})(this)).on("click.tour-" + this._options.name, ".tour-" + this._options.name + " *[data-role='end']", (function (_this) {
					return function (e) {
						e.preventDefault();
						return _this.end();
					};
				})(this)).on("click.tour-" + this._options.name, ".tour-" + this._options.name + " *[data-role='pause-resume']", function (e) {
				var $this;
				e.preventDefault();
				$this = $(this);
