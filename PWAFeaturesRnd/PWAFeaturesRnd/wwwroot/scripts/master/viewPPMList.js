...
$(document).ready(function () {
	...
	var ppmDueTable = $('#dtPPMDueList').DataTable({
        ...
        "columns": [
			{
				"data": "type",
				render: function (data, type, full, meta) { return GetCellData('Job Type', data); }
			},
			{
             ...
             },
			{
				className: "tdblock",
                "data": "job",
				render: function (data, type, full, meta) { return GetCellData('Job Name', '<a href="/PMS/Details">' + data + '</a>'); }
             },
			{
				"data": "status",
			...
			{
                "data": "leftHours",
				render: function (data, type, full, meta) { return GetCellData('Left Hours', data); }
             },
        ],
    });

	var ppmDueTable = $('#dtPPMMonList').DataTable({
		"dom": '<<"row"<"col-12 col-md-7"i><"col-12 col-md-5"f>><t><"row"<"col-12 col-md-7"l><"col-12 col-md-5"p>>>',
		"processing": true,
		"serverSide": false,
		"lengthChange": true,
	...
	var ppmDueTable = $('#dtPPMPriList').DataTable({
		"dom": '<<"row"<"col-12 col-md-7"i><"col-12 col-md-5"f>><t><"row"<"col-12 col-md-7"l><"col-12 col-md-5"p>>>',
		"processing": true,
		"serverSide": false,
		"lengthChange": true,
	...
	var ppmDueTable = $('#dtPPMAllList').DataTable({
		"dom": '<<"row"<"col-12 col-md-7"i><"col-12 col-md-5"f>><t><"row"<"col-12 col-md-7"l><"col-12 col-md-5"p>>>',
		"processing": true,
		"serverSide": false,
		"lengthChange": true,
		...
		"createdRow": function (row, data, dataIndex) {
			if (data.category == 'MON') {
				$(row).addClass('text-amber');
			}
			else if (data.category == 'PRI') {
		...
		"columns": [
			...
			},
			{
				className: "text-center",
				"data": "doneDate",
				render: function (data, type, full, meta) { return GetCellData('Done Date', data); }
			},
			{
				className: "tdblock",
				"data": "componentName",
			...
			},
			{
				className: "text-center",
				"data": "closedDate",
				render: function (data, type, full, meta) { return GetCellData('Closed Date', data); }
			},
			{
				"data": "classCode",
				render: function (data, type, full, meta) { return GetCellData('Class Code', data); }
			},
			{
				"data": "dept",
			...
			{
				"data": "workOrderType",
				render: function (data, type, full, meta) { return GetCellData('Work Order Type', data); }
			},
			{
				"data": "reportForm",
				render: function (data, type, full, meta) { return GetCellData('Report Form', data); }
			},
			{
				"data": "advDays",
				render: function (data, type, full, meta) { return GetCellData('Days', data); }
			},
			{
				"data": "stDeleted",
				render: function (data, type, full, meta) { return GetCellData('ST Deleted', data); }
			},
			{
				"data": "runningHour",
				render: function (data, type, full, meta) { return GetCellData('Running Hours', data); }
			},
			{
				"data": "attachments",
				render: function (data, type, full, meta) { return GetCellData('Attachments', data); }
			},
		],
	});


	$('.link-clicked').click(function () {
		$('#spSubtitle').text($(this)[0].innerText);
	});
	...
	//////////////////////////////----------------------------------------------------------------------------------------------------------/////////////////////////////////
	////////////////////////////// Below code is implemented for viewing Grid as Card in the Mobile View ----- Start
	//////////////////////////////----------------------------------------------------------------------------------------------------------/////////////////////////////////
	...
	var colDefs = [
		...
		},
		{
			...
			render: function (data, type, full, meta) { return GetCellData('Salary', data); }
		},
		{
			data: "start_date", name: "start_date", title: "Start", visible: true, class: 'text-right',
			render: function (data, type, full, meta) { return GetCellData('Start', data); }
		},
		{
			data: "office", name: "office", title: "Office", visible: true,
			render: function (data, type, full, meta) { return GetCellData('Office', data); }
		},
		{
			data: "extn", name: "extn", title: "Extn", visible: true,
			render: function (data, type, full, meta) { return GetCellData('Extn', data); }
		}
	];
	...
	//	this.console.log('this' + $(this).width());
	//	this.console.log('screen' + this.screen.width);
	//	if (this.screen.width > 600) {
	//		$("#register").removeClass('cards');
	//		$("#register thead").show();
	//	}
	//	else {
	...
	//////////////////////////////----------------------------------------------------------------------------------------------------------/////////////////////////////////
	////////////////////////////// Above code is implemented for viewing Grid as Card in the Mobile View ----- End
	//////////////////////////////----------------------------------------------------------------------------------------------------------/////////////////////////////////


	//daterangepicker ppmlist
	...
	function cb(start, end) {
		...
		$("#dtrppmlist").html(start.format("DD MMM YYYY") + " - " + end.format("DD MMM YYYY"));
	}

	$("#dtrppmlist").daterangepicker(
		{
			startDate: start,
			endDate: end,
			opens: "right",
